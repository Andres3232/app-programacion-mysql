...
var generJWT_1 = require("../helpers/generJWT");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                usuario = _b.sent();
                if (!usuario) {
                    return [2 /*return*/, res.render("Incorrecto")];
                }
                passwordString = password.toString();
                validPassword = bcryptjs_1.default.compareSync(passwordString, usuario.Password);
                if (!validPassword) {
                    return [2 /*return*/, res.render("Incorrecto")];
                    ;
                }
                return [4 /*yield*/, generJWT_1.generarJWT(usuario.id)];
            case 3:
                token = _b.sent();
